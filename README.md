...
6. On playit.gg website after adding a new agent, create a new tunnel, on the game select ```Minecraft Java```, scroll down on the ip put ```10.88.0.3``` on the port put ```8080```
